...
public class EarthquakeCityMap extends PApplet {
	...
	private void addKey() {	
		...
		fill(230, 30, 0);
		triangle(50, 100-6, 50-5, 100+3, 50+5, 100+3);
	...
	private void printQuakes() 
	{
		...
		for (Marker m : countryMarkers) {
			...
			if (num > 0) {
				System.out.println(m.getProperty("name") + "\t" + num + "earthquakes detected in this country.");
			}
		}
		int oceanNum = quakeMarkers.size() - islandNum;
		System.out.println(oceanNum + "quakes that were detected in the ocean");
	}
